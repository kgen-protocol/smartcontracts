...
//     public fun length(map: &BucketStore): u64 {
//         vector::length(&map.data)
//     }

//     // /// Create an empty BucketStore.
//     // public fun new<Key: store, Value: store>(): BucketStore<Key, Value> {
//     //     BucketStore {
//     //         data: vector::empty(),
//     //     }
//     // }

//     // /// Create a BucketStore from a vector of keys and values. The keys must be unique.
//     // public fun new_from<Key: store, Value: store>(
//     //     keys: vector<Key>,
//     //     values: vector<Value>,
//     // ): BucketStore<Key, Value> {
//     //     let map = new();
...
//     // public fun create<Key: store, Value: store>(): BucketStore<Key, Value> {
//     //     new()
//     // }

//     // public fun borrow<Key: store, Value: store>(
//     //     map: &BucketStore<Key, Value>,
//     //     key: &Key,
//     // ): &Value {
...
//     // public fun destroy_empty<Key: store, Value: store>(map: BucketStore<Key, Value>) {
//     //     let BucketStore { data } = map;
...
//     // public fun keys<Key: copy, Value>(map: &BucketStore<Key, Value>): vector<Key> {
...
//     // public fun values<Key, Value: copy>(map: &BucketStore<Key, Value>): vector<Value> {
//     //     vector::map_ref(&map.data, |e| {
//     //         let e: &Element<Key, Value> = e;
//     //         e.value
//     //     })
...
//     //     map: BucketStore<Key, Value>): (vector<Key>, vector<Value>) {
