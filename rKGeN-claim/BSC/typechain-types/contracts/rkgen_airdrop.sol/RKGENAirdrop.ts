...
export interface RKGENAirdropInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "_hashClaim",
    values: [AddressLike, AddressLike, BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "_verifyClaimSignature",
    values: [
      AddressLike,
      AddressLike,
      BigNumberish,
  ...
  decodeFunctionResult(functionFragment: "_hashClaim", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "_verifyClaimSignature",
    data: BytesLike
  ): Result;
...
export interface RKGENAirdrop extends BaseContract {
  ...
  _hashClaim: TypedContractMethod<
    [
      user: AddressLike,
      token: AddressLike,
      amount: BigNumberish,
  ...
  _verifyClaimSignature: TypedContractMethod<
    [
      user: AddressLike,
      token: AddressLike,
      amount: BigNumberish,
  ...
  >;
  getFunction(
    nameOrSignature: "_verifyClaimSignature"
  ): TypedContractMethod<
    [
      user: AddressLike,
      token: AddressLike,
